...
export class GenericTable {
  ...
  private grantTableRights() {
    // if the lambda exist as a nodejsfunction after init then grant the fn the correct permissions
  ...
  private createLambdas() {
    // if the lambda path/name exists then create a nodejsfunction and integrate it with the api gateway
