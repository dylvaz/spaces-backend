...
class IdentityPoolWrapper {
  ...
  private initializeIdentityPool() {
    this.identityPool = new CfnIdentityPool(this.scope, 'SpacesIdentityPool', {
  ...
  private attachRoles() {
    new CfnIdentityPoolRoleAttachment(this.scope, 'RolesAttatchment', {
